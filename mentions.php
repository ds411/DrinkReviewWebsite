...
foreach($initialFeedPosts as $post) {
    ...
    $body = $post->getBody();
    $initialFeed .=
        "<div class='feed-post'><p><a href='profile.php?u=$username' class='feed-user'>$name ($username)</a></p><p class='feed-body'>$body</p><hr/><p class='feed-time'>Posted on $timestamp</p></div>";
}
