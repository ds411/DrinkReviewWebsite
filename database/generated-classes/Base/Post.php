...
abstract class Post implements ActiveRecordInterface
{
    ...
    public function setCreationtime($v)
    {
        ...
        if ($this->creationtime !== null || $dt !== null) {
            if ($this->creationtime === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->creationtime->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PostTableMap::COL_CREATIONTIME] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PostTableMap::translateFieldName('Username', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PostTableMap::translateFieldName('Creationtime', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aUser !== null && $this->username !== $this->aUser->getUsername()) {
            $this->aUser = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostTableMap::COL_CREATIONTIME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostTableMap::COL_CREATIONTIME)) {
            $criteria->add(PostTableMap::COL_CREATIONTIME, $this->creationtime);
        }
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && (($this->username !== "" && $this->username !== null))) {
            $this->aUser = ChildUserQuery::create()->findPk($this->username, $con);
