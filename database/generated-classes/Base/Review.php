...
abstract class Review implements ActiveRecordInterface
{
    ...
    public function setRating($v)
    {
        ...
        if ($this->rating !== $v) {
            $this->rating = $v;
            $this->modifiedColumns[ReviewTableMap::COL_RATING] = true;
        }
    ...
    public function setPostId($v)
    {
        ...
        if ($this->post_id !== $v) {
            $this->post_id = $v;
            $this->modifiedColumns[ReviewTableMap::COL_POST_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 3; // 3 = ReviewTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function hashCode()
    {
        ...
        //relation review_fk_ed85ac to table post
