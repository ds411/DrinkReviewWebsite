...
class CompanyTableMap extends TableMap
{
     ...
     */
    const COL_PICTURE = 'company.picture';

    /**
     * the column name for the location field
     */
    const COL_LOCATION = 'company.location';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Picture', 'Location', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'picture', 'location', 'description', ),
        self::TYPE_COLNAME       => array(CompanyTableMap::COL_ID, CompanyTableMap::COL_NAME, CompanyTableMap::COL_PICTURE, CompanyTableMap::COL_LOCATION, CompanyTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'picture', 'location', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Picture' => 2, 'Location' => 3, 'Description' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'picture' => 2, 'location' => 3, 'description' => 4, ),
        self::TYPE_COLNAME       => array(CompanyTableMap::COL_ID => 0, CompanyTableMap::COL_NAME => 1, CompanyTableMap::COL_PICTURE => 2, CompanyTableMap::COL_LOCATION => 3, CompanyTableMap::COL_DESCRIPTION => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'picture' => 2, 'location' => 3, 'description' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CompanyTableMap::COL_PICTURE);
            $criteria->addSelectColumn(CompanyTableMap::COL_LOCATION);
