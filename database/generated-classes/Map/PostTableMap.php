...
class PostTableMap extends TableMap
{
     ...
     */
    const COL_CREATIONTIME = 'post.creationTime';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Username', 'Body', 'Creationtime', ),
        self::TYPE_CAMELNAME     => array('id', 'username', 'body', 'creationtime', ),
        self::TYPE_COLNAME       => array(PostTableMap::COL_ID, PostTableMap::COL_USERNAME, PostTableMap::COL_BODY, PostTableMap::COL_CREATIONTIME, ),
        self::TYPE_FIELDNAME     => array('id', 'username', 'body', 'creationTime', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Username' => 1, 'Body' => 2, 'Creationtime' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'username' => 1, 'body' => 2, 'creationtime' => 3, ),
        self::TYPE_COLNAME       => array(PostTableMap::COL_ID => 0, PostTableMap::COL_USERNAME => 1, PostTableMap::COL_BODY => 2, PostTableMap::COL_CREATIONTIME => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'username' => 1, 'body' => 2, 'creationTime' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PostTableMap::COL_CREATIONTIME);
        } else {
