...
foreach($postModels as $post) {
    ...
    $posts .=
        "<div class='feed-post'><p><a href='profile.php?u=$username' class='feed-user'>$username</a>$drink</p>$rating<p class='feed-time'>Posted on $timestamp</p><p class='feed-body'>$body</p></div>";
}
