...
if(isset($_POST['page'])) {
    ...
    //If there are more posts, generate html and return it
        ...
        foreach($feedPosts as $post) {
            ...
            $feed .=
                "<div class='feed-post'><p><a href='profile.php?u=$username' class='feed-user'>$name</a>$drink</p>$rating<p class='feed-body'>$body</p><p class='feed-time'>Posted on $timestamp</p></div>";
        }
